...
export function IconEntry(p: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...p}>
...
export function IconSwitch(p: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...p}>
...
export function IconStore(p: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...p}>
      <path d="M3 9l1.5-5h15L21 9M4 9v11a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V9M3 9h18" />
    </svg>
  );
}
...
export function IconBulb(p: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...p}>
